...
class Follow(models.Model):
    followerId = models.ForeignKey(
        User, related_name='following', on_delete=models.CASCADE)  # 关注者
    followingId = models.ForeignKey(
        User, related_name='followers', on_delete=models.CASCADE)  # 被关注者
...
class Comment(models.Model):
    ...
    videoID = models.ForeignKey(
        Video, related_name='comment', on_delete=models.CASCADE)
